...
static uint32_t gen_mask(uint32_t x) {
  uint32_t m;
...
void Mars_set_key(uint32_t *l_key, uint32_t *vk, const uint32_t *in_key,
                  const uint32_t key_len) {
  uint32_t m = key_len / 32 - 1;
...
void Mars_encrypt(const uint32_t *l_key, const uint32_t *in_blk,
                  uint32_t *out_blk) {
  uint32_t a = in_blk[0] + l_key[0];
  uint32_t b = in_blk[1] + l_key[1];
  uint32_t c = in_blk[2] + l_key[2];
  uint32_t d = in_blk[3] + l_key[3];
...
void Mars_decrypt(const uint32_t *l_key, const uint32_t *in_blk,
                  uint32_t *out_blk) {
  uint32_t d = in_blk[0] + l_key[36];
  uint32_t c = in_blk[1] + l_key[37];
  uint32_t b = in_blk[2] + l_key[38];
  uint32_t a = in_blk[3] + l_key[39];
